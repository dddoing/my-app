        ...
        <Helmet>
            ...
            (
                error ? <Message color="red" text={error}/> :
                    <Container>
                        <Helmet>
                            <title>{result.original_title ? result.original_title : result.original_name} || Example</title>
                        </Helmet>
                        ...
                        <Content>
                            ...
                            <Data>
                                ...
                                <ItemContainer>
                                    ...
                                    <Divider>•</Divider>
                                    <Item>{result.genres && result.genres.map(
                                        (genre, index) => index === result.genres.length - 1 ? genre.name : `${genre.name}/`)}</Item>
                                </ItemContainer>
                                <Overview>
                                    {result.overview}
                                </Overview>
